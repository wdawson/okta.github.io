...
> The [System Log API](/docs/api/resources/system_log) will eventually replace the Events API and contains much more [structured data](/docs/api/resources/system_log#logevent-object). Developers of new projects are strongly recommended to use the System Log API in lieu of the Events API.
