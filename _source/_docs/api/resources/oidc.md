...
| display               | How to display the authentication and [consent](/docs/api/resources/apps#add-oauth-20-client-application) UI. Valid value: `page` for the Okta-hosted consent page, `page` or `popup` for authentication                                                                                                                                                                                                                                                                                                                      | Query      | String   | FALSE    |
