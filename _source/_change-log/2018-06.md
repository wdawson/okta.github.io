...
excerpt: API Access Management is Generally Available for Preview, new System Log messages and bugfixes
---
...
| [New Admin Role for API Access Management](#new-admin-role-for-api-access-management) | February 7, 2018 | starting February 12, 2018 |
...
#### New Admin Role for API Access Management
...
To change the role assigned to a user, use [the Admin Roles API](/docs/api/resources/roles) or visit **Security > Administrators** in the Okta user interface. <!--OKTA-107617-->
...
The following bug has been fixed and are expected in preview orgs February 7, 2018 and production orgs starting February 12, 2018.
