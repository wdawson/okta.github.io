...
[The Zones API](/docs/api/resources/zones) is an {% api_lifecycle ea %} release. Contact Support to enable it.
...
* Some requests to update a user via [`/api/v1/users/:uid`](/docs/api/resources/users#update-user) failed with a 500 Internal Server Error. (OKTA-138214)