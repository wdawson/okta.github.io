...
For more information, see [Identity Provider Signing Key Store Operations](https://developer.okta.com/docs/api/resources/idps#identity-provider-signing-key-store-operations)
or [Update Key Credential for Application](https://developer.okta.com/docs/api/resources/apps#update-key-credential-for-application).
