...
| -------------------------------------------------------------------------------------------------------------------- | ------------------------ | -------------------------------------------- |
| [System Log API is Generally Available](#system-log-api-is-generally-available-ga)                                   | June 13, 2018            | June 18, 2018                                |
...
The [System Log API](/docs/api/resources/system_log) is now Generally Available. Developers of new projects are strongly recommended to use this in lieu of the Events API. <!-- OKTA-174890 -->
