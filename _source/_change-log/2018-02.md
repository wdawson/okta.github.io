...
Use the [App User Schema API](/docs/api/resources/schemas.html#app-user-schema-operations) to work with App User profiles, typically for apps that have features for provisioning users.<OKTA-154105>
