...
To enable an Early Availability (EA) feature, contact Okta Support. For more information, see [Okta Release Lifecycle](/docs/api/getting_started/releases-at-okta). 
