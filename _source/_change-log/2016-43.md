...
The [OpenID Connect discovery endpoint](/docs/api/resources/oidc#openid-connect-discovery-document) `.well-known` includes the introspection and revocation endpoints.
