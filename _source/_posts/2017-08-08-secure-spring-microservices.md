...
**Update:** To learn how to lock down this application with Spring Security and OAuth, see [Secure a Spring Microservices Architecture with Spring Security and OAuth](/blog/2018/02/13/secure-spring-microservices-with-oauth).
