...
[source,bash]
----
npm i -g generator-jhipster@5.7.0
----
...
[source,bash]
----
npm i -g ignite-cli@2.1.6 ignite-jhipster@2.0.2
----
...
Log in to your Okta Developer account and navigate to **Applications** > **Add Application**. Click **Web** and click **Next**. Give the app a name you'll remember, and specify `http://localhost:8080/login` as a Login redirect URI and click **Done**. Note the client ID and secret, you'll need to copy/paste them into a file in a minute.
...
* Dec 10, 2018: Updated to use Ignite JHipster 2.0.2 and JHipster 5.7.0. You can see the example app changes in [okta-react-native-spring-boot-example#1](https://github.com/oktadeveloper/okta-react-native-spring-boot-example/pull/1); changes to this post can be viewed in [okta.github.io#2541](https://github.com/okta/okta.github.io/pull/2541).