...
Refresh your app in Simulator using kbd:[{commandkey} + M]. When you create new points, you should see your new defaults.
...
You'll also need to remove a couple of properties, due to an https://github.com/jhipster/generator-jhipster/issues/8518[issue I discovered in JHipster].
