...
This article showed you how to develop a reactive API with Spring WebFlux and secure it using Spring Security's excellent OIDC support. In a future post, we'll show you link:/blog/2018/09/24/reactive-apis-with-spring-webflux[how to create a React UI for this API] and provide you with techniques for handling streaming data in your browser.
