...
* https://developer.okta.com/blog/2018/09/21/reactive-programming-with-spring[Get Started with Reactive Programming in Spring]
* https://www.baeldung.com/spring-webflux[Guide to Spring 5 WebFlux]
* https://developer.okta.com/blog/2018/07/19/simple-crud-react-and-spring-boot[Use React and Spring Boot to Build a Simple CRUD App]
* https://developer.okta.com/blog/2017/12/18/spring-security-5-oidc[Get Started with Spring Security 5.0 and OIDC]
* https://developer.okta.com/blog/2017/08/01/oidc-primer-part-3[What's in a Token? – An OpenID Connect Primer, Part 3 of 3]
